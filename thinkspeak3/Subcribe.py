...
thresh_temperature  = 20


def on_message(client, userdata, msg):
	global thresh_temperature
	...
	text = "Warning room %s : Temperature %2.1f" % (room, Temperature)

	print("T > t " ,(Temperature > thresh_temperature))
	if (Temperature > thresh_temperature) :
		print(text)
...
thresh_temperature = float(input("enter thresh of temperature : "));
client = mqtt.Client()
